...
export class Payment extends SmartContract{
    ...
    // public key hash of the univerity
    @prop()
    universityPKH: PubKeyHash;
    @prop(true)
    lastWithdrawTimestamp: bigint;


    constructor(withdrawIntervals: bigint, withdrawAmount: bigint,creatorPkh: PubKeyHash, universityPKH: PubKeyHash, lastWithdrawTimestamp: bigint) {
        super(...arguments);
        this.withdrawIntervals = withdrawIntervals;
        this.withdrawAmount = withdrawAmount;
        this.creatorPkh = creatorPkh;
        this.universityPKH = universityPKH;
    ...
    public withdraw() {
        ...
        let withdrawOutput: ByteString = Utils.buildOutput(Utils.buildPublicKeyHashScript(this.universityPKH), this.withdrawAmount);
        // require 3 outputs
    ...
    @method()
    public deposit(depositAmount: bigint ,sig: Sig, pk: PubKey) {
       ...
       let expectedOutput: ByteString = Utils.buildOutput(this.getStateScript(), this.ctx.utxo.value + depositAmount);
